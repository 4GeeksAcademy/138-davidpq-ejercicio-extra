...
Empieza a programar un juego de Piedra, Papel o Tijera usando JavaScript.

## Objetivo

Crear un juego que:

- Reciba la elección del usuario mediante un `prompt()`
- Genere una elección aleatoria para la máquina
...
### 1. Crea un array con las opciones del juego
...
- recibir la elección del usuario como parámetro
...
para seleccionar un elemento aleatorio del array.

---

### 4. Pide la elección del usuario

Usa un `prompt()` para preguntar al usuario:
...
### 5. Muestra quien gana la partida
...
## Limpia el texto que introduce el usuario

Asegúrate de que la comparación funcione incluso si el usuario escribe:
...
Asegúrate de que el usuario solo pueda introducir:

- piedra
- papel
- tijera

Si escribe otra cosa, muestra un mensaje de error.
...
- prompt()
- console.log()
- Strings y métodos de texto

---

# Extra (Opcional)

Si terminas rápido, intenta añadir:

- Lagarto y Spock
- Contador de puntos
- Varias rondas
- Validación de inputs
- Interfaz visual con HTML
- Mostrar imágenes según la opción elegida
